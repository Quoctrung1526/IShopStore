            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <h1 class="mb-5 display-3 text-primary">Điện Máy và Gia Dụng</h1>
        ...
        <div class="container-fluid vesitable py-5">
            <div class="container py-5">
                ...
                <div class="owl-carousel vegetable-carousel justify-content-center">
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="" class="img-fluid w-100 rounded-top bg-light" alt>
                        </div>
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            style="top: 10px; right: 10px;">Vegetable</div>
                        <div class="p-4 rounded-bottom">
...
// Hàm mô phỏng các thư viện JS động cần thiết (nếu có)
...
/* Featurs */
.featurs .featurs-item .featurs-content {
    margin-top: -30px;
}
